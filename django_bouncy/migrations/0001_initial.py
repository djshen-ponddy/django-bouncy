    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bounce_type', models.CharField(max_length=50, verbose_name='Bounce Type', db_index=True)),
                ('bounce_subtype', models.CharField(max_length=50, verbose_name='Bounce Subtype', db_index=True)),
                ('reporting_mta', models.TextField(null=True, blank=True)),
                ('action', models.CharField(db_index=True, max_length=150, null=True, verbose_name='Action', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback_type', models.CharField(db_index=True, max_length=150, null=True, verbose_name='Complaint Type', blank=True)),
